<%@ Page Title="" Language="C#" MasterPageFile="~/Chemist/Chemist.Master" AutoEventWireup="true" CodeBehind="EmergencyRequest.aspx.cs" Inherits="MedoNew.Chemist.EmergencyRequest" %>
    ...
    <div class="container mt-5" id="FormDiv">
        <div class="card mt-3 orderTab ">
            <div class="card-header badge-info" style="text-align: center; background-color: #033b4d; color: #fff;">
                <h5 class="pt-1">Emergency Medicine Request</h5>
            </div>
            <div class="card-body">
