...
namespace MedoNew
{
    public partial class shop : System.Web.UI.Page
    {
        ...
        private void bind_datalist()
        {
            ...
            {
                query = "Select * from  dbo.ProductDetails where Categoryid='"+ Request.QueryString["category_id"].ToString() + "'";
            }
            ...
            if (e.CommandName == "add_cart") // check command is cmd_delete
            {
                ...
                if (checkdb.Tables[0].Rows.Count > 0)
                {
                   ...
                   /* Session["FId"] = checkdb.Tables[0].Rows[0]["ChemistId"];*/
                    ...
                    int chemistid = Convert.ToInt32(checkdb.Tables[0].Rows[0]["ChemistId"]);
