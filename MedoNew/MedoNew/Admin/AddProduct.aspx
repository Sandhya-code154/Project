...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="MedoNew.Admin.AddProduct" %>
                ...
                <asp:GridView ID="dgv" runat="server" class="table table-bordered table-responsive text-center" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Created By">
                            <ItemTemplate>
                                <asp:Label ID="lblcreate" runat="server" Text='<%#Eval("user_id") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
