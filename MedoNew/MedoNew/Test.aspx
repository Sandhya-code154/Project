<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="MedoNew.Test" %>
                        ...
                        <div class="card ViewDivNew" id="">
                            <div class="card-body cart mt-5">
                                <div class="col-sm-12 empty-cart-cls text-center">
                                    ...
                                    <a href="Product.aspx" class="btn cart-btn mt-4 text-capitalize" data-abc="true">continue shopping</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ItemTemplate>
                        <div class="card mb-5 " id="ProdCard">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <img class="img-fluid" src='/Images/ProdDesc/<%#Eval("ProdImg") %>' alt="" height="170" width="170">
                                    </div>
